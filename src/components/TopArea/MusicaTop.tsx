...
const MusicaTop = (props: itemProps) => {
  return (
    <div className="w-[23rem] h-28 hover:bg-[#FFF0EC] rounded-e-lg hover:border-l-2 hover:-ml-0.5 hover:border-secondaryColor text-gray-200 hover:text-secondaryColor flex items-center ">
