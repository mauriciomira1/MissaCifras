...
const ArtistaTop = (props: itemProps) => {
  return (
    <div className="w-60 h-28 hover:bg-[#F5F5F5] rounded-s-lg hover:border-r-2 hover:-mr-0.5 hover:border-primaryColor text-gray-200 flex items-center ">
      ...
      <div className="flex flex-col font-text items-end mr-3">
        <h2 className="text-right uppercase leading-5 font-highlight text-primaryColor text-2xl cursor-pointer hover:text-secondaryColor">
          {props.Author}
        </h2>
